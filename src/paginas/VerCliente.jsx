    ...
    return (
        ...
        Object.keys(cliente).length === 0 ? <p>No hay resultados</p> : (
            <div>
                ...
                {cliente.nombre && (
                    <p className='text-4xl text-gray-600 mt-10'><span className='text-gray-800 uppercase font-bold'> Nombre:</span> {cliente.nombre}</p>
                )}
                {cliente.correo && (
                    <p className='text-2xl text-gray-600 mt-4'><span className='text-gray-800 uppercase font-bold'> Correo:</span> {cliente.correo}</p>
                )}
                {cliente.telefono && (
